...
export default function (inject, { Store }) {
    ...
    const renderApp = (CurrentAppRoutes) => {
        ReactDOM.render(<HotLoaderAppContainer errorReporter={consoleErrorReporter}>
        <ApolloProvider store={Store} client={apolloClient}>
          <CurrentAppRoutes history={history} injectDeps={inject}/>
        </ApolloProvider>
      </HotLoaderAppContainer>, getRootNode('react-root'));
    };
    renderApp(AppRoutes);
    if (module.hot) {
        // /**
        ...
        module.hot.accept('../modules/routes.jsx', () => {
            const NextAppRoutes = require('../modules/routes').default;
